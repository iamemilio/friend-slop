...
const TestNorayTransport := preload("res://tests/unit/test_noray_transport.gd")
...
func _run_tests() -> void:
	...
	var noray_transport_suite := TestNorayTransport.new()
	failures += noray_transport_suite.run()
